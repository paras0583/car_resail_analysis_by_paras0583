...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        """
        This function creates and returns a ColumnTransformer object
        with numerical and categorical pipelines.
        """
        try:
            numerical_columns = ['mileage','make_year','no_of_owners','registration_year']
    ...
    def initiate_data_transformation(self, train_path, test_path):
        """
        This function reads train and test data, applies preprocessing,
        and returns transformed numpy arrays along with preprocessor file path.
        """
        try:
